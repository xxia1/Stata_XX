...
At the same time, this is designed to be a \textit{meta-}project: This article comes with a companion Git repository: \url{https://github.com/xxia1/Stata_XX}, which includes all code, exhibits, and folder structure used to generate this article. One can find examples of the tools mentioned in this article in the repository, and can use this repository as a template for other projects. 
